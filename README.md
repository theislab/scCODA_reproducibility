...
**Note: Since running the benchmarks is very resource intensive, we provided all generated data and benchmark results via [zenodo](https://zenodo.org/record/5578002#.YkXNgDdBxAc)!**
...
2.  a) Download the benchmark data and results from [zenodo](https://zenodo.org/record/5578002#.YkXNgDdBxAc)
