...
save_path_server = os.path.realpath('/home/icb/johannes.ostner/compositional_diff/benchmark_results/overall_benchmark_2/')

models = ["scCODA"]

# Dont try running this at home! There are 150.000 datasets in this benchmark!
util.benchmark(dataset_path_server, save_path_server, models, "overall", server=True, keep_results=True)
# util.benchmark(dataset_path, save_path, models, "overall", server=False, keep_results=True)
